                    ...
                    <form method="post">
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="categories" placeholder="Enter Product name"
                                       class="form-control" required value="<?php echo $name ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">MRP</label>
                                <input type="text" name="mrp" placeholder="Enter Mrp" class="form-control" required
                                       value="<?php echo $mrp ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Quantity</label>
                                <input type="text" name="qty" placeholder="Enter Quantity name" class="form-control"
                                       required value="<?php echo $qty ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Image</label>
                                <input type="file" name="images" placeholder="Enter Image" class="form-control" required
                                       value="<?php echo $images ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Short description</label>
                                <input type="text" name="short_desc" placeholder="Shot description" class="form-control"
                                       required value="<?php echo $short_desc ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" placeholder="Enter Product meta_title"
                                       class="form-control" required value="<?php echo $meta_title ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Meta description</label>
                                <input type="text" name="meta_desc" placeholder="Enter meta description"
                                       class="form-control" required value="<?php echo $meta_desc ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Meta keyword</label>
                                <input type="text" name="meta_keyword" placeholder="Enter Meta keyword"
                                       class="form-control" required value="<?php echo $meta_keyword ?>">
                            </div>
